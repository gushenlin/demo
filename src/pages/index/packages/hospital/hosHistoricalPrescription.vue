    <template>
  <!--<template><div>历史处方查询 hosHistoricalPrescription</div></template>-->
  <div class="cloud-component hosHistoricalPrescription">
    ...
    <div class="cloud-search el-form-item-small">
      <el-form :inline="true" :model="ruleForm" ref="ruleForm" @submit.native.prevent>
        <el-form-item label="处方单号：" prop="hisPrescCode">
          <el-input v-model.trim="ruleForm.hisPrescCode"
    ...
    <div class="cloud-search-list">
      <echarts-contain containType="big" :parentHeight="routerViewHeight" :heightRatio="1">
        <el-table :height="(dataList.content && dataList.content.length>0)?(routerViewHeight*1-40):(routerViewHeight*1-5)"
          ...
          <el-table-column prop="hisPrescCode" label="处方单号" min-width="12%" show-overflow-tooltip>
          </el-table-column>
    ...
    methods: {
      ...
      getDataList (pageNo = this.pageNo, pageSize = this.pageSize) {
        ...
        let formData = {
          ...
          args: {
            'hisPrescCode': that.params_ruleForm.hisPrescCode,
            ...
            'hospitalId': JSON.parse(sessionStorage.getItem('userInfo')).orgId
          }
        };
        that.$axios({
          method: 'post',
