<template>
  <div class="cloud-component cloud-component-detail furthurDetail">
    ...
    <div class="cloud-search-list">
      <echarts-contain containType="big" :parentHeight="routerViewHeight+30" :heightRatio="1">
        ...
        <el-table :height="routerViewHeight*1-280" :data="dataList.content" style="width: 100%" v-loading="loading"
                  :empty-text="emptyText" :element-loading-text="elementLoadingText" highlight-current-row>
...
<style scoped>
  ...
  .cloud-search:before, .cloud-search:after {
    content: '';
    width: 25px;
    height: 1px;
