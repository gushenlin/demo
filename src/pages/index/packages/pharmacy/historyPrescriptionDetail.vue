    ...
    <div class="cloud-search  el-form-item-small">
      <!--<div class="cloud-title">-->
        <div class="searchTitle">
          <span>历史处方查询</span>
          <el-button @click="$router.go(-1)" type="text" style="margin-left: 15px">
            &lt&lt返回上一级
          </el-button>
        </div>
      <!--</div>-->
      <el-form :inline="true" :model="ruleForm" ref="ruleForm" class="mt15" @submit.native.prevent>
        <el-form-item>
          <el-button type="primary" @click="search" size="mini" :loading="loading">打印便笺</el-button>
