<template>
  <div class="cloud-component extensionPrescriptionList">
    <div class="searchTitle">
      <span>外延处方统计</span>
      <el-button @click="historyGoBack('/extensionPrescription')" type="text" style="margin-left: 15px">
        &lt&lt返回上一级
      </el-button>
    </div>
    <div class="subtext">
    ...
    methods: {
      ...
      getDataList (pageNo = this.pageNo, pageSize = this.pageSize) {
        ...
        that.$axios({
          ...
          url: '/peps/presc/hospital/search/page?v=' + (+new Date()),
          data: formData
        }).then((response) => {
          that.loading = false;
